            ...
            <div className="space-y-8">
                ...
                {courses.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <Link to="/receitas/gestao">
                            <Button>Começar a adicionar receitas</Button>
                        </Link>
                    </div>
                )}
                ...
                {courses.length > 0 && inProgressCourses.length === 0 && (
                    <div className="text-center py-12 bg-slate-50 dark:bg-slate-800 rounded-lg">
                        <p className="text-slate-600 dark:text-slate-400 text-lg mb-4">
                            Você ainda não começou nenhuma receita!
                        </p>
                        <p className="text-slate-500 dark:text-slate-500 text-sm mb-4">
                            Escolha uma receita abaixo ou navegue pela biblioteca completa.
                        </p>
                        <Link to="/receitas">
